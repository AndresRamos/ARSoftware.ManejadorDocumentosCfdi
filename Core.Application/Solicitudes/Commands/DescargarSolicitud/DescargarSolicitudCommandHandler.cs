...
public sealed class DescargarSolicitudCommandHandler : IRequestHandler<DescargarSolicitudCommand>
{
    ...
    public DescargarSolicitudCommandHandler(ManejadorDocumentosCfdiDbContext context, IMediator mediator, IDescargaService descargaService)
    {
        _context = context;
        _mediator = mediator;
